...
export async function getStaticProps() {
    ...
    /* const reportsData = await getReportsData("Maceió, AL"); */
    return {
        props: {
            aboutData,
            //reportsData,
                ...
                <div className="wrapper">
                    ...
                    <div className={styles.content}>
                        ...
                        <div className={styles.description}>
                            <div className={`${styles[`column-1`]} ${aboutInstancesVisible === true ? "fadeIn" : "fadeOut"}`}>
            ...
            <section id='community' className={styles.community}>
                <div className="wrapper">
                    ...
                    <div className={styles.content}>
                        ...
                        <p>Junte-se a <span className="big">22.329</span> outras pessoas que decidiram tornar suas cidades mais
                            limpas.</p>
                    </div>
                </div>
            </section>
            ...
            <section id='download' className={styles.download}>
                ...
                <div className={`wrapper ${styles.faq}`}>
                    ...
                    <div className={styles.question}>
                        <a href="/perguntas-frequentes.html#por-que-o-aplicativo-nao-esta-disponivel-para-dispositivos-ios">
                            <InfoIcon />
                            Por que o aplicativo não está disponível para dispositivos iOS?
                            <LinkIcon />
                        </a>
                        <a href="/perguntas-frequentes.html#por-que-o-aplicativo-nao-esta-disponivel-na-playstore">
                            <InfoIcon />

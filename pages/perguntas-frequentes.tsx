...
import styles from "../styles/pages/perguntas-frequentes.module.css"
            ...
            <section id="questions">
                <div className="wrapper">
                    <div className="content">
                        <div className="pergunta" id="por-que-o-aplicativo-nao-esta-disponivel-para-dispositivos-ios">
                            <header>
                                <h4>Pergunta 1</h4>
                        ...
                        <div className="pergunta" id="por-que-o-aplicativo-nao-esta-disponivel-na-playstore">
                            <header>
                                <h4>Pergunta 2</h4>
